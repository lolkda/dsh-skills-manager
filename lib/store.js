/**
 * 插件状态：`$DSH_HOME/skills-manager/state.json`。
 *
 ...
 * @returns {string} `$DSH_HOME/skills-manager`
 */
export function storeDir(dshHome) {
  return join(dshHome, 'skills-manager')
}
...
export function logPath(dshHome) {
  return join(dshHome, 'dsh-skills-manager.log')
}
